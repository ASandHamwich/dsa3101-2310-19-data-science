...
NusDseTitleList = []
#list of modules obtained from nus dsa/dse requirements from official nus website
...
NusDsaORSpecMods = ['MA3236','MA3252','MA3227','MA3238','ST3236','MA4230','MA4251','ST4238','MA4260','MA4268','MA4270','DSA4288M'] #Operation Research Specialization
NusDsaSMSpecMods = ['ST3232','ST3239','ST3247','ST3248','ST4231','ST4234','ST4248','ST4250','ST4253','DSA4288S'] #Statistical Methodology Specialization
...
#list of url for each module in DSA and DSE
...
for x in range(len(NusDsaModsCode)):
    ...
    ls = []
    for i in table:
        ls.append(i.find('p').text) #getting the module description
    table = soup.find('h1',attrs={"class":"kbFQ8zbG"}).contents[-1] #getting the module title
