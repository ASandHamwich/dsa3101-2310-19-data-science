...
skillsdsa1101 = "R, machine learning, probability and statistics"
skillsdsa3101 = "Git, docker, Dash, Plotly"
skillsdsa3102 = "Convex optimization, KKT"
    ...
    if mod_code == 'dsa1101':
        return html.Div(
            children = [
                ...
                html.P(skillsdsa1101),
                html.H4('Reviews[WIP]'),
                html.P('No Reviews Yet')
